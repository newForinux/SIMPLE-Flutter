...
class _CategorySelectionPageState extends State<CategorySelectionPage> {
  String convenience_store = '편의점';
  String office_supplies = '사무용품';
        ...
        child: Container(
          child: GridView.count(
            ...
            children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, '/home', arguments: convenience_store);
                  },
                  child: Padding(
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/home', arguments: office_supplies);
                },
                child: Padding(
                  padding: EdgeInsets.zero,
                  child: Column(
